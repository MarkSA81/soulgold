...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_TINKATINK] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAK, ABILITY_OWN_TEMPO, ABILITY_PICKPOCKET },
        .innates = { ABILITY_QUICK_FORGE },
    ...
    [SPECIES_TINKATUFF] =
    {
        ...
        .innates = { ABILITY_QUICK_FORGE, ABILITY_MAGNET_PULL },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_TINKATON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_OWN_TEMPO, ABILITY_PICKPOCKET },
        .innates = { ABILITY_QUICK_FORGE, ABILITY_MAGNET_PULL, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_PINK,
